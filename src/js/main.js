...
chrome.storage.local.get('CurrentTemplate', function(res) {
    if (res.CurrentTemplate) {
        ...
        templateBox.innerHTML = res.CurrentTemplate.style;
