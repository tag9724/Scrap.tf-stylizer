...
if ( typeof BBCode === "undefined" ) {
    ...
    var BBCode = new class BBCODE_PARSER {
        ...
        constructor() {
            ...
            this.scrapTFEmotes = [ "43nero", "8killer", "BibleThump", "NiGHTS", "VerdigrisV", "VermillionV", "VictoriaV", "VioletV", "ViridianV", "VitellaryV", "administrator", "altaria", "angelcake", "angry_mouse", "antelion", "antonio", "applejack", "arcticfox", "art", "auroz", "backstab", "balloons", "bap", "batcountry", "bday", "bernep", "bghd", "bigD", "bigM", "bigP", "bionicbunion", "birdspy", "bluecrab", "blush_mouse", "brohoof", "brohoof2", "burningrose", "butts", "cage", "cake", "captainfalcon", "catty_evil", "catty_good", "catty_sad", "catty_strange", "celestia", "cheep", "cheez", "chrysalis", "cloudbean", "cm", "cookie", "coolpika", "coolpika2", "corona", "counterfloofeon", "crashygrumpy", "crashyshocked", "crashysilly", "crashysmile", "csdfrown", "custard", "derp", "derpjesse", "derpmouse", "derpshay", "derpzoro", "devsuns", "dfly", "diaheart", "dima", "dimablush", "dimahappy", "dimasad", "dogtor", "doorknob", "drak", "duk", "ead", "eatom", "ech", "eep", "elizhappy", "elizhappy2", "elizmad", "elizsurprise", "emptyengie", "enclaveblue", "eomvestigate", "eyes", "faxon", "feesh", "fennekin", "fish", "floofeh", "floofeon", "fluttercry", "fluttershy", "fluttersmile", "flutteryay", "foxy", "fryingpan", "fume", "furr", "furry", "gaben", "gasp_mouse", "giantdad", "gibus", "glasses", "grandpa", "grizz", "h3art", "hale", "hamshank", "handshake", "happy_mouse", "happykitty", "hearthstone", "heyguys", "holy", "hoovy", "hug", "huge", "hugpile", "hundkopf", "huzzah", "hysterical", "icebear", "ies", "ika", "ineff", "ineffoh", "ineffp", "jac", "janfav", "janno", "janstop", "jantran", "januduck", "jemmy", "jemmy43", "jibanyan", "katuen", "kick", "kingdedede", "kirby", "lakota", "lazypanda", "likeaboss", "littlebuddy", "lucina", "luna", "manface", "maxs", "melting", "metaknight", "monkey", "moon2", "mousey", "mrx", "niko83c", "noise", "nolove", "nom", "norman", "odd", "oops_mouse", "osu", "otter", "otter2", "overwatch", "p_mouse", "panda", "papa", "para", "phantomhappy", "phantommeh", "phantomsad", "phantomsurprised", "pie", "pile", "pillfox", "pinkamena", "pinkiepie", "pinky", "pixeleevee", "pixeleeveefestive", "pixeleeveefestive2", "pixeleeveelove", "pizza", "plagueoverseer", "poi", "pokeball", "polishedturd", "pootis", "pops", "popsicle", "pout", "predecessor", "princess", "pspikawink", "puzzle", "pxbang", "qt", "questionblock", "rabbit", "raffle", "rainbowdash", "rarecandy", "rarity", "rdspeechless", "reaper", "reclaimed", "redcrab", "refined", "ruby", "runningbomb", "sad_mouse", "salad", "sandvich", "sap", "scott713", "scrambler", "scrap", "seth", "shako", "shaman", "sharkedtreasure", "sharkie", "shiba", "sillyfume", "slice", "smallmeep", "smashball", "smile_mouse", "smileinhd", "smithhealz", "sonicth", "soulie", "spanty", "spooky", "sprintingbomb", "squib", "squib2", "squib3", "squibbody", "starco", "starfloof", "steam", "suuslime", "szorua", "tardis", "teamcaptain", "telegram", "tf2sniper", "tfm_confetti", "thedoc", "thunderbomb", "tip", "tip2", "toot", "tophat", "trump", "twilightsparkle", "uncraftable", "vinyl", "weiss", "whip", "whiterabbit", "woh", "woof", "wub", "wuff", "yv", "zeke", "zomg", "zorua" ];
        ...
        Parse( str, parseAdmin ) {
            ...
            while ( ( res = this.parse.url.exec( str ) ) !== null ) {
                result = result.replace( res[ 0 ], '<a target="_blank" href="' + res[ 1 ] + '">' + res[ 0 ] + '</a>' );
            }
