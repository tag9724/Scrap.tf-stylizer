( function () {
    ...
    let raffleMessage = Array.from( document.querySelectorAll( '.raffle-message:not(.puzzle):nth-child(1n):not(.raffle-password)' ) );
    ...
    raffleOwnerGrade = ( raffleOwnerGrade == "Admin" || raffleOwnerGrade == "Mod" );
